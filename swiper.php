  ...
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide">
      ...
      <div class="p-mainvisual__layer--index" style="
        ...
        background: url(http://hotel.local/wp-content/themes/hamburger/assets/images/mv_main@2x.jpg); 
    ...
    <div class="swiper-slide">
      ...
      <div class="p-mainvisual__layer--index" style="
          ...
          background: url(http://hotel.local/wp-content/themes/hamburger/assets/images/mv_egg_orange.jpg);
          background-position: 50% 50%;
          background-size: cover;
        ">
    ...
    <div class="swiper-slide">
      ...
      <div class="p-mainvisual__layer--index" style="
          ...
          background: url(http://hotel.local/wp-content/themes/hamburger/assets/images/burger_poteto_salada.jpg);
          background-position: 50% 50%;
          background-size: cover;
        ">
    ...
    <div class="swiper-slide">
      ...
      <div class="p-mainvisual__layer--index" style="
          ...
          background: url(http://hotel.local/wp-content/themes/hamburger/assets/images/salad-2068220_1920.jpg);
          background-position: 50% 50%;
          background-size: cover;
        ">
